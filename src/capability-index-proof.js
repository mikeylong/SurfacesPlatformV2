...
function buildReport({ runId, indexRef, implemented, planned, validationResults, diagnostics }) {
  ...
  return {
    ...
    runId,
    targetId: CI_TARGET_ID,
    scopeStatement: "Reports the current proof and governance status of the 12 declared implemented targets plus planned capability groups.",
