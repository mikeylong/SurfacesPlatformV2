...
export async function runInterfacectl(argv, io) {
  ...
  if (argv[0] === "surfaces" && argv[1] === "spectrum-switch-catalog" && argv[2] === "proof") {
    const { runSpectrumSwitchCatalogInterfacectl } = await import("./spectrum-switch-catalog-proof.js");
    return runSpectrumSwitchCatalogInterfacectl(argv.slice(3), io);
  }
