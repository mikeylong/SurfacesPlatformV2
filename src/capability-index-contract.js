...
const IMPLEMENTED_CAPABILITIES = [
  ...
  implemented({
    capabilityId: "spectrum-checkbox-catalog",
    displayName: "Spectrum Checkbox catalog authority",
    roadmapPhase: "Target",
    proofMode: "bounded-local",
    userValue: "Adds one common selection control to a governed real-source catalog with checked state, policy, and token authority.",
    scopeStatement: "Consumes accepted P2 evidence and one separately locked Checkbox source byte to emit a distinct governed catalog containing Button, Checkbox, and InLineAlert.",
    authorityRole: "declared-source-catalog-expansion",
    nonCapabilities: [
      "in-place P2 expansion",
    ...
    lifecycleRoles: ["connect-authority", "govern-change"],
    proofCommand: "interfacectl surfaces spectrum-checkbox-catalog proof",
    packageProofScript: "proof:spectrum-checkbox-catalog",
    ciGate: "npm run check:spectrum-checkbox-catalog:ci",
    evidencePath: "artifacts/spectrum-checkbox-catalog/evidence.json",
    evidenceSchemaId: "spectrum-checkbox-catalog-evidence.v0",
    expectedPromotionStatus: "review_required",
    inputPaths: [
      "artifacts/p2/evidence.json",
      "artifacts/p2/governed-catalog.json",
      "sources/spectrum-checkbox-catalog",
    ...
    diagnosticSchemaPath: "schemas/spectrum-checkbox-catalog-diagnostics.v0.schema.json",
    reportPaths: ["artifacts/spectrum-checkbox-catalog/spectrum-checkbox-catalog-report.json"],
    documentationRefs: ["VISION.md", "PLAN.md", "plans/spectrum-checkbox-catalog.md"],
    dependencies: { evidence: ["p2-spectrum-ingestion"], phaseGate: [], compatibility: [] }
  }),
  implemented({
    ...
    roadmapPhase: "Target",
    proofMode: "report-only",
    userValue: "Compiles checked source facts and team-owned authority policy from two compatible bundles into actionable governed results.",
    scopeStatement: "Runs the unchanged fact-level compiler over exactly two manifest-declared local authority bundles for Button and InLineAlert, preserving the accepted P2 boundary without expanding catalog capability.",
    authorityRole: "declared-source-policy-consumer",
    nonCapabilities: ["arbitrary source connector", "broader P2 component coverage", "live source crawling", "self-serve connection UI"],
    lifecycleRoles: ["connect-authority", "govern-change"],
    proofCommand: "interfacectl surfaces source-family-packaging proof",
    packageProofScript: "proof:source-conformance",
    ciGate: "npm run check:source-family-packaging:ci",
    evidencePath: "artifacts/source-family-packaging/evidence.json",
    evidenceSchemaId: "source-family-packaging-evidence.v0",
    inputPaths: ["artifacts/p2/evidence.json", "artifacts/p2/governed-catalog.json", "artifacts/source-conformance/evidence.json", "artifacts/source-conformance/governed-catalog.json", "sources/source-conformance", "sources/source-family-packaging", "fixtures/source-conformance", "fixtures/source-family-packaging"],
    outputPaths: [
    ...
    diagnosticSchemaPath: "schemas/source-family-packaging-diagnostics.v0.schema.json",
    reportPaths: ["artifacts/source-conformance/authority-connection-report.json", "artifacts/source-conformance/source-conformance-report.json", "artifacts/source-family-packaging/candidate-authority-connection-report.json", "artifacts/source-family-packaging/candidate-source-conformance-report.json", "artifacts/source-family-packaging/source-family-packaging-report.json"],
  ...
  implemented({
    capabilityId: "source-family-component-identity-mapping",
    displayName: "Source family component identity mapping",
    roadmapPhase: "Target",
    proofMode: "report-only",
    userValue: "Removes one exact component-identity constraint for one checked bundle and fixed TeamButton to Button declaration.",
    scopeStatement: "Verifies one checked TeamButton to Button declaration, maps exactly 22 declared identity values in five files, refreshes five manifest hashes, preserves four narrative Button fields in the accepted 12-file bundle, and runs the unchanged source-conformance compiler without expanding authority.",
    authorityRole: "derived-component-identity-normalization-consumer",
    nonCapabilities: [
    ...
    lifecycleRoles: ["connect-authority", "govern-change"],
    proofCommand: "interfacectl surfaces source-family-component-identity-mapping proof",
    packageProofScript: "proof:source-family-component-identity-mapping",
    ciGate: "npm run check:source-family-component-identity-mapping:ci",
    evidencePath: "artifacts/source-family-component-identity-mapping/evidence.json",
    evidenceSchemaId: "source-family-component-identity-mapping-evidence.v0",
    expectedPromotionStatus: "review_required",
    inputPaths: [
      "artifacts/p2/evidence.json",
      "artifacts/p2/governed-catalog.json",
    ...
    diagnosticSchemaPath: "schemas/source-family-component-identity-mapping-diagnostics.v0.schema.json",
    reportPaths: ["artifacts/source-family-component-identity-mapping/source-family-component-identity-mapping-report.json"],
    documentationRefs: ["PLAN.md", "VISION.md", "plans/source-family-component-identity-mapping.md"],
    dependencies: {
      evidence: ["p2-spectrum-ingestion", "declared-source-conformance", "source-family-layout-mapping", "source-family-namespace-mapping"],
      phaseGate: [],
      compatibility: []
    }
  }),
