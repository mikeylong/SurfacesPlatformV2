...
export const SAP_SCHEMAS = {
  ...
  "source-accessibility-policy-fixture.v0.schema.json": schema("source-accessibility-policy-fixture.v0", {
    required: ["schemaId", "version", "fixtureId", "behaviorId", "declarationOverride", "authorityConflict", "ambiguity", "reviewRouteMutation", "freeFormPolicyText", "catalogMutation", "integrityMutation"],
    properties: { schemaId: { const: "source-accessibility-policy-fixture.v0" }, version: { const: SAP_VERSION }, fixtureId: string, behaviorId: nullableString, declarationOverride: { anyOf: [declarationSchema, { type: "null" }] }, authorityConflict: { anyOf: [{ type: "object", additionalProperties: false, required: ["catalogPointer", "primaryFactRef", "primaryValue", "supportingFactRefs", "supportingValues", "selectedValue", "resolutionMode", "policyRef"], properties: { catalogPointer: string, primaryFactRef: { type: "string", pattern: "^declared-source://source-conformance/components/[^#]+#/facts/[0-9]+/value$" }, primaryValue: jsonValue, supportingFactRefs: { type: "array", minItems: 1, uniqueItems: true, items: { type: "string", pattern: "^declared-source://source-conformance/components/[^#]+#/facts/[0-9]+/value$" } }, supportingValues: { type: "array", minItems: 1, items: jsonValue }, selectedValue: jsonValue, resolutionMode: { enum: ["primary-precedence", "unresolved"] }, policyRef: string } }, { type: "null" }] }, ambiguity: { anyOf: [{ type: "object", additionalProperties: false, required: ["candidatePointers", "reviewRouteId"], properties: { candidatePointers: { type: "array", minItems: 2, uniqueItems: true, items: string }, reviewRouteId: string } }, { type: "null" }] }, reviewRouteMutation: { anyOf: [{ type: "object", additionalProperties: false, required: ["routeId", "owner"], properties: { routeId: string, owner: nullableString } }, { type: "null" }] }, freeFormPolicyText: nullableString, catalogMutation: { anyOf: [{ type: "object", additionalProperties: false, required: ["catalogPointer", "value"], properties: { catalogPointer: string, value: jsonValue } }, { type: "null" }] }, integrityMutation: { anyOf: [{ type: "object", additionalProperties: false, required: ["kind", "targetPath", "jsonPointer", "replacementValue"], properties: { kind: { enum: ["source-hash", "evidence-hash"] }, targetPath: string, jsonPointer: { type: "string", pattern: "^/" }, replacementValue: jsonValue } }, { type: "null" }] } }
  }),
...
function baseFixture(fixtureId, behaviorId = null) { return { schemaId: "source-accessibility-policy-fixture.v0", version: SAP_VERSION, fixtureId, behaviorId, declarationOverride: null, authorityConflict: null, ambiguity: null, reviewRouteMutation: null, freeFormPolicyText: null, catalogMutation: null, integrityMutation: null }; }
function buildFixtures() {
  ...
  put("valid/policy-authorized-precedence.source-accessibility-policy.json", { ...baseFixture("policy-authorized-precedence", "button-accessible-name"), authorityConflict: { catalogPointer: "/components/Button/accessibility/role", primaryFactRef: "declared-source://source-conformance/components/button.json#/facts/1/value", primaryValue: "button", supportingFactRefs: ["declared-source://source-conformance/components/button-acquired-a.json#/facts/1/value", "declared-source://source-conformance/components/button-acquired-b.json#/facts/1/value"], supportingValues: ["link", "link"], selectedValue: "button", resolutionMode: "primary-precedence", policyRef: "declared-source://source-conformance/policies/source-precedence.json#/" } });
  ...
  put("invalid/precedence-unresolved.source-accessibility-policy.json", { ...baseFixture("precedence-unresolved", "button-accessible-name"), authorityConflict: { catalogPointer: "/components/Button/accessibility/role", primaryFactRef: "declared-source://source-conformance/components/button.json#/facts/1/value", primaryValue: "button", supportingFactRefs: ["declared-source://source-conformance/components/button-acquired-a.json#/facts/1/value", "declared-source://source-conformance/components/button-acquired-b.json#/facts/1/value"], supportingValues: ["link", "link"], selectedValue: "button", resolutionMode: "unresolved", policyRef: "declared-source://source-conformance/policies/source-precedence.json#/" } });
  ...
  put("mutations/source-hash-mismatch.source-accessibility-policy.json", { ...baseFixture("source-hash-mismatch", null), integrityMutation: { kind: "source-hash", targetPath: "sources/source-accessibility-policy/manifest.json", jsonPointer: "/sourceFiles/0/sha256", replacementValue: "0".repeat(64) } });
  put("mutations/evidence-hash-mismatch.source-accessibility-policy.json", { ...baseFixture("evidence-hash-mismatch", null), integrityMutation: { kind: "evidence-hash", targetPath: "schemas/source-accessibility-policy-fixture.v0.schema.json", jsonPointer: "/artifacts/0/hash", replacementValue: "0".repeat(64) } });
  const inputs = [
    `${SAP_FIXTURE_ROOT}/expectations.manifest.json`,
