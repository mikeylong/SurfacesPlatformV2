...
19. [Capability Index Proof Target](capability-index.md)
...
source-family component-identity mapping, Spectrum Checkbox catalog, designer-workflow trace,
...
2. The 17 accepted target evidence files declared by the capability fixture
